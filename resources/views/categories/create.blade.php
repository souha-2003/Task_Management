    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-12">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h2 class="fw-bold mb-0 text-dark">➕ {{ __('messages.create_category') }}</h2>
                    ...
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center gap-3 mt-2">
                                <input type="color" id="color" name="color" class="form-control form-control-color border shadow-sm" style="width: 80px; height: 45px; cursor: pointer;" value="{{ old('color', '#3b82f6') }}" required>
